...
function VideoCarousel() {
  const videos = [
    ...
    { id: 2, title: 'Video 2', thumbnail: thumbnail2, videoUrl: video2 },
    { id: 3, title: 'Video 3', thumbnail: thumbnail1, videoUrl: video1 },
        ...
        {videos.map((video, index) => (
          <SwiperSlide key={video.id}>
            <Box
              ...
              cursor="pointer"
            >
          <video src={videos[currentVideo].videoUrl} ref={videoRef} style={{ width: '85%', height: 'auto',marginLeft:'8%' }} controls />             
           <IconButton
